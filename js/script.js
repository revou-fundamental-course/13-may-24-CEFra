...
about.addEventListener("click", function (event) {
  ...
  contentDiv.innerHTML = `
    ...
    <div class="keterangan">
        <p>Kalkulator ini dibuat oleh Rendy Luis. Tujuan dibuatnya kalkulator ini adalah untuk menyelesaikan tugas "mini coding project" dari kelas RevoU Fundamental Course: Software Engineer  </p>
    </div>
    `;
});
